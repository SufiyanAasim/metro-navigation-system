...
[`.github/workflows/release.yml`](../../.github/workflows/ci.yml) triggers on any pushed tag matching `v*`:
...
To cut a release: update `CHANGELOG.md`, commit, tag (`git tag v2.1.0`), and push the tag (`git push origin v2.1.0`). See [RELEASE.md](../../RELEASE.md) for the full process.
